 ...
 * @UpdateTerminals
 */
class ControllerExtensionModuleOmnivaltUpdateTerminals extends Controller
{
  public function index()
  {
    print 'Starting Omniva terminal list update';
    $this->fetchUpdates();
    print 'Omniva terminal succesfully updated';
    return 'succes';
  }
  ...
  private function parseCSV($csv, $countries = array())
  {
    ...
    if (strpos($rows[0], 'ZIP;') === false) {
      die ('Terminal CSV file is in wrong format');
    }
