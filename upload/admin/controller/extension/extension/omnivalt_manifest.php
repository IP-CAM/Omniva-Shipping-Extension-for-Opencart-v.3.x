 ...
 */
class ControllerExtensionExtensionOmnivaltManifest extends Controller
{
    public function index()
    {
        ...
        $pagination->url = $this->url->link('extension/omnivalt/omnivalt', 'user_token=' . $this->session->data['user_token'] . '&page={page}#imp', 'SSL');
        ...
        $data['action'] = $this->url->link('extension/omnivalt/omnivalt/newManifest', 'user_token=' . $this->session->data['user_token'], true);
        $data['button_cancel'] = $this->language->get('button_cancel');
        $data['skip'] = $this->url->link('extension/omnivalt/omnivalt/skipOrder', 'user_token=' . $this->session->data['user_token'], true);
        $data['cancelSkip'] = $this->url->link('extension/omnivalt/omnivalt/cancelSkip', 'user_token=' . $this->session->data['user_token'], true);
        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=shipping', true);
        $data['client'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['user_token'], true);
        $data['genLabels'] = $this->url->link('extension/omnivalt/omnivaltPrints/labels', 'user_token=' . $this->session->data['user_token'], true);
        $data['labels'] = $this->url->link('extension/omnivalt/omnivaltPrints/printDocs', 'user_token=' . $this->session->data['user_token'], true);
        $data['currentManifest'] = $this->config->get('omniva_manifest');
        $data['newManifest'] = 'Naujas Manifestas';
        $data['token'] = $this->session->data['user_token'];
        $data['search'] = $this->url->link('extension/omnivalt/omnivalt/searchOmnivaOrders', 'user_token=' . $this->session->data['user_token'], true);
    ...
    public function skipOrder()
    {
        if (!isset($this->request->get['order_id'])) {
            $this->redirect($this->url->link('extension/omnivalt/omnivalt', 'user_token=' . $this->session->data['user_token'], true));
        }
        ...
        $this->response->redirect($this->url->link('extension/omnivalt/omnivalt', 'user_token=' . $this->session->data['user_token'], true));
...
//      $response = $this->load->controller('extension/shipping/omnivalt/api_request', $xmlRequest);
        ...
        $response = $this->load->controller('extension/omnivalt/omnivaltAPI/api_request', $xmlRequest);
